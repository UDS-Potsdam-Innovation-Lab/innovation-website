      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            <img src="/api/placeholder/600/400" alt="Digital Innovation Ecosystem" className="rounded-br-xl shadow-lg transform hover:scale-105 transition-transform duration-500" />
          </div>
