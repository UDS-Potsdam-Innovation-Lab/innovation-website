      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Our diverse portfolio of investments reflects our commitment to innovation and growth in the digital education sector.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-white p-6 md:p-8 rounded-br-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg md:text-xl font-bold text-orange-500 mb-2 md:mb-3">German UDS Service GmbH</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white p-6 md:p-8 rounded-br-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg md:text-xl font-bold text-orange-500 mb-2 md:mb-3">FB Cloudhouse GmbH</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white p-6 md:p-8 rounded-br-xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg md:text-xl font-bold text-orange-500 mb-2 md:mb-3">German UDS gGmbH</h3>
            <p className="text-gray-600 text-sm md:text-base">
